  ...
  Widget build(BuildContext context) {
    ...
    List<DatatableHeader> _headers = [
      ...
      DatatableHeader(
          ...
          sortable: true,
          sourceBuilder: (value, row) {
            PaymentReport _payment =   PaymentReport.fromJSON(row);
                      ...
                      onPressed: () {
                        ...
                        showDialog(context: context,
                            builder: (BuildContext context){
                              return PaymentDetailsViewWidget(payment: _payment,);
                            }
                        );
                      },
                      color:Colors.green,
                    ...
                    children: [
                      Wrap(
                        children:[
                         ...
                         Text('Admin',style:Theme.of(context).textTheme.caption.merge(TextStyle(color:Colors.white54))),
                          SizedBox(width:10),
