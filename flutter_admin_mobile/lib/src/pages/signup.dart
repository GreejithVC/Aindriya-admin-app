...
class _SignUpState extends State<SignUp> {
  ...
  void initState() {
    ...
    super.initState();
    widget.con.listenForDropdown('shop_type', 'type', 'status', 'success');
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          onSaved: (input) => widget.con.registerData.name = input,
                        ...
                        TextFormField(
                          onSaved: (input) => widget.con.registerData.emailId = input,
                              ...
                              onChanged: (value) {
                                setState(() {
                                  //  _con.subcategoryData.categoryId = value;
                                   widget.con.registerData.shopTypeId = value;
                                  _value = value;
                                });
                              }),
                        ),
                        SizedBox(height: 20),
                        TextFormField(
                          onSaved: (input) => widget.con.registerData.phone = input,
