...
import '../elements/AEDeliveryFeesWidget.dart';
            ...
            child: new Column(
              ...
              children: [
                ...
                new ListTile(
                  ...
                  onTap: ()  async{
                     await _con.delete('deliveryFees',id);
...
class DeliveryFeesPopupHelper {
  ...
  static exit(context,con,deliveryFeesDetails,pageType) => showDialog(context: context, builder: (context) =>  AEDeliveryFeesWidget(con:con,deliveryFeesDetails: deliveryFeesDetails,pageType: pageType, ));
}
