                                          ...
                                          rows: _con.invoiceDetailsData.productDetails.map((CartResponce map) {
                                            ...
                                            return new  DataRow(
                                                cells: [
                                                  ...
                                                  DataCell( 1==2?Text('${map.product_name}     variant: ${map.quantity}, Addon: ${variantName.toString()} '):Text('${map.product_name} variant:${map.variant}${map.unit}  ')),
                                                  DataCell(Text(Helper.pricePrint(map.price))),
