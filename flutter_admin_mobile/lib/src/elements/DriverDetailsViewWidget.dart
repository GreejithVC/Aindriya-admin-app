...
import 'package:login_and_signup_web/src/models/driver.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                  ...
                  children:[
                    Text('Driver ID',style:Theme.of(context).textTheme.subtitle1),
                    Container(
              ...
              Row(
                  ...
                  children:[
                    ...
                    Container(
                        width:size.width > 670 ? size.width * 0.2: 140,
                        alignment: Alignment.topRight,
                        child:Text(widget.driverData.storeId,
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style:Theme.of(context).textTheme.subtitle1)
                    ),
