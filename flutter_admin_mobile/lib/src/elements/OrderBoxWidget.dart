...
import 'AssignDriverPopup.dart';
import 'AutoAssignWidget.dart';
import 'PrescriptionPopup.dart';
...
class OrderBoxWidget extends StatefulWidget {
  ...
  String tabTab;
  OrderController con;
  OrderBoxWidget({Key key, this.orderDetails, this.tabTab, this.con}) : super(key: key);
  @override
                              ...
                              Expanded(
                                  child: Wrap(children: [
                                    Padding(
                                      ...
                                      child: Text('ID -${widget.orderDetails.orderId} - (shopId ${widget.orderDetails.shopId})' ),
                                    ),
