...
class AEDeliveryFeesWidget extends StatefulWidget{
  AEDeliveryFeesWidget({Key key, this.con, this.pageType, this.deliveryFeesDetails}) : super(key: key);
  SecondaryController con;
  String pageType;
  DeliveryFees deliveryFeesDetails;
  @override
  _AEDeliveryFeesWidgetState createState() => _AEDeliveryFeesWidgetState();
}

class _AEDeliveryFeesWidgetState extends StateMVC<AEDeliveryFeesWidget> {
